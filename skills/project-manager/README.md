...
| `judge-reviews --file INPUT [--run ID] [--token T]` | record PM's drift utility score or code-panel order/ties in signed state; see [references/review-judgments.md](references/review-judgments.md) |
